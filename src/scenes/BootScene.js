...
export class BootScene extends Phaser.Scene {
  ...
  preload() {
    ...
    // Custom bumper sprites (250x250 PNG, transparent background — official earkandi art,
    // trimmed to alpha bbox and fit to a 250x250 canvas so BUMPER_VIS.SCALE stays uniform)
