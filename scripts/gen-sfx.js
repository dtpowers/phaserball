...
// Kick drum — pitch sweep 150Hz→60Hz, 200ms (replace with custom kick.wav)
writeKick('public/assets/sfx/kick.wav');
// Hi-hat — white noise burst, 80ms (replace with custom hihat.wav)
writeWav('public/assets/sfx/hihat.wav', 0, 0.08, 'noise');
